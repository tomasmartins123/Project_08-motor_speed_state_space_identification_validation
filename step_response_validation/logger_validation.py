# Project CRIA 08 - Automatic Serial Data Logger for Identification
# Logs raw step response data from Arduino to 'step_response_validation_data.csv'.
...
SERIAL_PORT = "COM3"
BAUD_RATE = 115200
OUTPUT_FILE = "step_response_validation_data.csv"
DURATION_SEC = (
    6.5 
)
